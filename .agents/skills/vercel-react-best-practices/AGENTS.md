...
**`@phillips/seldon`:** This repo is a **component library**. Prefer bundle,
re-render, rendering, JS, and advanced sections for day-to-day work; treat
**server-side** and **API route** chapters as **consumer-app** guidance unless you
are explicitly reviewing SSR integration code.

...
describe('FavoritesCollectionTile', () => {
  ...
  describe('renders count and name correctly', () => {
    it.each([
  ...
  describe('action callbacks', () => {
    ...
    it('calls the onEdit function when the edit list button is clicked', () => {
      ...
      render(
        <FavoritesCollectionTile {...sharedProps} count={2} name="New List" onEdit={mockOnEdit} variant="lists" />,
      );
      const menuTrigger = screen.getByTestId('menu-trigger');
      act(() => {
        menuTrigger.click();
  ...
  describe('blank and empty list states', () => {
  ...
  describe('create variant interactions', () => {
    ...
    it('renders the correct aria-label for the create variant', () => {
      render(
        <FavoritesCollectionTile
          ...
          name=""
          variant="create"
          createFirstListText="Create List"
        />,
      );

  ...
  <Header {...props}>
    <Navigation id={`${px}-main-nav`} backBtnLabel="← Back">
      <NavigationList>
        ...
        <NavigationItemTrigger label={`Departments`}>
          <NavigationList>
            <NavigationItem
              href="#"
              navGroup={'nav-link-sm'}
        ...
        <NavigationItemTrigger label={`Exhibitions`}>
          <NavigationList>
            <NavigationItem
              badge={'New York'}
              href="#"
        ...
        <NavigationItemTrigger label={`Buy & Sell`}>
          <NavigationList>
        ...
        <NavigationItemTrigger label={`About Us`}>
          <NavigationList>

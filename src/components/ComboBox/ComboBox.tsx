...
export interface ComboBoxProps extends CommonProps, Record<string, unknown> {
  /**
   * Button contents
   */
...
const ComboBox = ({ buttonType = 'primary', size = 'md', children, iconLast = false, id, ...props }: ButtonProps) => {
  return (
    <button

  ...
  <Footer {...props}>
    ...
    <Social>
      <ul>
        <li>
          <a>
            <Icon icon="Instagram" height="0.8rem" />
          </a>
        </li>
        <li>
          <a>
            <Icon icon="LinkedIn" height="0.8rem" />
          </a>
        </li>
        <li>
          <a>
            <Icon icon="Wechat" height="0.8rem" />
          </a>
        </li>
        <li>
          <a>
            <Icon icon="Red" height="0.8rem" />
          </a>
        </li>
        <li>
          <a>
            <Icon icon="Facebook" height="0.8rem" />
          </a>
        </li>
      </ul>
    </Social>

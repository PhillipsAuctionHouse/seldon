...
interface MagnificentSevenProps extends React.HTMLAttributes<SVGSVGElement> {
  color?: string;
...
const MagnificentSeven = memo(
  forwardRef<SVGSVGElement, MagnificentSevenProps>((inlineProps, ref) => {
...
export default MagnificentSeven;

...
const SvgPhillipsLogo = (props, ref) => (
  <svg
  ...
  >
    <g clipPath="url(#PhillipsLogo_a)">
      <path
        ...
        className="phillips-logo"
      />
    </g>
    <defs>
      <clipPath id="PhillipsLogo_a">
        <path fill="#fff" d="M0 0h130.667v14H0z" />
      </clipPath>
    </defs>
  </svg>
);
const ForwardRef = forwardRef(SvgPhillipsLogo);

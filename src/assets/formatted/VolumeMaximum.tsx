...
interface VolumeMaximumProps extends React.HTMLAttributes<SVGSVGElement> {
  color?: string;
...
const VolumeMaximum = memo(
  forwardRef<SVGSVGElement, VolumeMaximumProps>((inlineProps, ref) => {

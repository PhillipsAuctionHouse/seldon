...
interface PhillipsLogoProps extends React.HTMLAttributes<SVGSVGElement> {
  color?: string;
...
const PhillipsLogo = memo(
  forwardRef<SVGSVGElement, PhillipsLogoProps>((props, ref) => {
    const { height, width, title, titleId: propsTitleId, color, ...rest } = props;
    const titleId = propsTitleId || kebabCase(title || '');

    // Use the supplied color prop for the logo fill when provided, otherwise fall back to black

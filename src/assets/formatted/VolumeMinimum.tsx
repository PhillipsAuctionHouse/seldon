...
interface VolumeMinimumProps extends React.HTMLAttributes<SVGSVGElement> {
  color?: string;
...
const VolumeMinimum = memo(
  forwardRef<SVGSVGElement, VolumeMinimumProps>((inlineProps, ref) => {
